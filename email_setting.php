        ...
        <form method="post">
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input name="edugorilla_subject" value="<?php echo $edugorilla_email_subject;?>" placeholder="Type Email Subject here...">
            	...
            	<tr>
                    ...
                    <td>
                        <textarea name="edugorilla_body" rows="4" cols="65" placeholder="Type Email Body here..."><?php echo $edugorilla_email_body;?></textarea>
