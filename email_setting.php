...
?>
    <div class="wrap">
        ...
        <div id="tabs">
          <ul>
              <li><a href="#tabs-1">Promotional Leads</a></li>
              <li><a href="#tabs-2">EduCash Allotted</a></li>
          ...
          <div id="tabs-1">
            <?php
                ...
                if ($email_setting_form1 == "self") {
                    ...
                    if (empty($errors1)) {
                        $edugorilla_email_setting1 = array('subject' => $edugorilla_email_subject1, 'body' => $edugorilla_email_body1);
                ...
                <form method="post">
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <input name="edugorilla_subject1" value="<?php echo $edugorilla_email_subject1; ?>"
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="edugorilla_body1" rows="4" cols="65"
                                          placeholder="Type Email Body here..."><?php echo $edugorilla_email_body1; ?></textarea>
